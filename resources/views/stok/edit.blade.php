    ...
    <form action="{{ route('stok.update', $stok->id) }}" method="POST">
      ...
      <div class="border-b border-gray-900/10 pb-12">
        ...
        <div class="mt-10 col-span-full gap-y-8">
          <label for="id_stok" class="block text-sm/6 font-medium text-gray-900">ID Barang</label>
          <div class="mt-2">
        ...
        <div class="mt-5 col-span-full gap-y-8">
          <label for="jml_keluar" class="block text-sm/6 font-medium text-gray-900">jml_keluar</label>
          <div class="mt-2">
        ...
        <div class="mt-5 col-span-full gap-y-8">
            <label for="total_barang" class="block text-sm/6 font-medium text-gray-900">total_barang</label>
            <div class="mt-2">
